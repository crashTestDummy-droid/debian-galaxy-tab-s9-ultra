...
libcamera_version=0.7.2+53.g62d4bfc-gts9u9
...
git apply \
	...
	/build/camera-inputs/libcamera/0006-center-gpu-metering-and-track-focus.patch \
	/build/camera-inputs/libcamera/0007-reduce-noise-in-software-focus-metric.patch
meson setup build \
	--buildtype=release \
	--prefix=/usr \

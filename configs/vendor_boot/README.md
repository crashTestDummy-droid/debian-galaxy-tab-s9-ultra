...
para poder comparar. **No se usa.** La cmdline de esta ROM difiere en tres
cosas, y una de ellas es imprescindible:
...
anteriores siguen existiendo y llevan una raíz arrancable del port Ubuntu
original etiquetada `UBTS9U_ROOT`. Con la misma etiqueta en los dos sitios, `root=LABEL=` habría
